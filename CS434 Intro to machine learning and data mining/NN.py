...
Original file is located at
    https://colab.research.google.com/drive/1L8EnQFgdNWv0qbFLQuCp_pjR1QFICSZK
"""
...
def main():
  ...
  result_test = np.argmax(logits_test,axis=1)[:,np.newaxis]
  #print(result_test)
  #print(result_test.shape)

  test_out = np.concatenate((np.expand_dims(np.array(range(4220),dtype=np.int), axis=1), result_test), axis=1)
